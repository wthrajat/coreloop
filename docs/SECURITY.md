...
Coreloop is an invite-only private application. Report a vulnerability to the
repository owner privately; do not include provider keys, Telegram tokens,
session cookies, user profiles, lesson bodies, or database exports in an issue.

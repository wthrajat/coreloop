...
func tursoManualBatchResult(requestNumber int) string {
	...
	case 4:
		return `{"baton":"tx-1","results":[{"type":"ok","response":{"type":"execute","result":{"cols":[{"name":"id"},{"name":"source_id"},{"name":"normalized_url"},{"name":"discovery_json"},{"name":"relevance_score"}],"rows":[[{"type":"text","value":"rad_first"},{"type":"text","value":"src_one"},{"type":"text","value":"https://openai.com/news/update"},{"type":"text","value":"[]"},{"type":"float","value":0.99}],[{"type":"text","value":"rad_second"},{"type":"text","value":"src_two"},{"type":"text","value":"https://go.dev/blog/update"},{"type":"text","value":"[]"},{"type":"float","value":0.97}],[{"type":"text","value":"rad_third"},{"type":"text","value":"src_three"},{"type":"text","value":"https://github.blog/update"},{"type":"text","value":"[]"},{"type":"float","value":0.95}]],"affected_row_count":0,"last_insert_rowid":null}}}]}`
	case 5, 6:
